...
\begin{itemize}
	...
	Al\'em da p\'agina com o rep\'ositorio dos \'icones, o design e o conceito dos itens \'e explicado no seguinte artigo. \url{<https://material.io/guidelines/style/icons.html#icons-system-icons>}
	
	\item \textbf{\textit{Material Colors}} - Uma ferramenta que ajuda na escolha da paleta de cores que v\~ao compor o aplicativo, ele oferece tamb\'em um guia visual de como ficam as cores nas interfaces do sistema. Outro artigo relacionado \'e o https://material.io/guidelines/style/color onde \'e explicado as boas pr\'aticas e guias para selecionar as cores dos componentes da interface do aplicativo.
\end{itemize}
\end{document}